...
export default function AboutPage() {
  return (
    <div className="max-w-4xl mx-auto">
      <h1 className="text-3xl md:text-4xl font-bold text-center mb-8 text-amber-600">About SbAnswer</h1>
      ...
      <div className="space-y-8">
        <section className="bg-amber-50 p-6 rounded-xl border border-amber-100 shadow-sm">
          ...
          <p className="text-gray-700 leading-relaxed">
            SbAnswer was created with two main goals: to help word game enthusiasts find solutions to the New York Times Spelling Bee puzzle, and to provide free practice puzzles for those looking to improve their skills. We believe that word games are not just fun but also educational, helping to expand vocabulary and keep the mind sharp.
          </p>
        </section>
        ...
        <section className="bg-gradient-to-br from-amber-50 to-yellow-50 p-6 rounded-xl border border-yellow-100 shadow-sm">
          ...
          <p className="text-gray-700 leading-relaxed">
            SbAnswer is maintained by a small team of word game enthusiasts and developers who are passionate about creating useful tools for the Spelling Bee community. We continuously work to improve our tools and add new features based on user feedback.
          </p>
        </section>
